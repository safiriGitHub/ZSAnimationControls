...
#import "ZSScaleLabel.h"

@interface ZSScaleLabel ()
...
- (void)startAnimation {
    ...
    [UIView animateWithDuration:1 delay:0 usingSpringWithDamping:7 initialSpringVelocity:4 options:UIViewAnimationOptionCurveEaseInOut
                     animations:^{
                         ...
                         self.backedLabel.alpha     = 1.f;
                         self.backedLabel.transform = CGAffineTransformMake(1, 0, 0, 1, 0, 0);
                         
                         self.colorLabel.alpha      = 1.f;
                         self.colorLabel.transform  = CGAffineTransformMake(1, 0, 0, 1, 0, 0);;
                         ...
                         [UIView animateWithDuration:2 delay:0.5 usingSpringWithDamping:7 initialSpringVelocity:4
                                          ...
                                          animations:^{
                                              ...
                                              self.colorLabel.alpha     = 0.f;
                                              self.colorLabel.transform = CGAffineTransformMake(self.endScale, 0, 0, self.endScale, 0, 0);
